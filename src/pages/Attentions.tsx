...
const Attentions: React.FC<IPage & {setCurrentObject: (value: any) => void;}> = ({setShowAddModal, setShowDeleteModal, setShowEditModal, refresh, setCurrentId, setCurrentObject}) => {
