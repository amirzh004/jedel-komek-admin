...
import {deletePoliceStation} from "../../api/api.tsx";

const DeletePoliceStationModal: React.FC<IModal & {id: number, data: ICategory}> = ({showModal, setShowModal, id, data, refresh, setRefresh}) => {
...
export default DeletePoliceStationModal;