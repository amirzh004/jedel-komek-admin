...
import {createPoliceStation} from "../../api/api.tsx";

const AddPoliceStationModal: React.FC<IModal> = ({showModal, setShowModal, refresh, setRefresh}) => {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            await createPoliceStation(formData);
