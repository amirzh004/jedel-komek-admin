...
import {editEducation} from "../../api/api.tsx";

const EditEducationalModal: React.FC<IModal & {id: number, data: ICategory}> = ({showModal, setShowModal, refresh, setRefresh, data, id}) => {
...
export default EditEducationalModal;