...
import {deleteNews} from "../../api/api.tsx";

const DeleteNewsModal: React.FC<IModal & {id: number, data: any}> = ({showModal, setShowModal, id, data, refresh, setRefresh}) => {
            ...
            <div className="delete__modal" onClick={(e) => e.stopPropagation()}>
                ...
                <form onSubmit={handleDelete}>
                    <div className="modal__body">
                        <p>
                            Вы уверены, что хотите удалить категорию {data?.title}?
                        </p>
