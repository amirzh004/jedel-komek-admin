...
import {editPoliceStation} from "../../api/api.tsx";

const EditPoliceStationModal: React.FC<IModal & {id: number, data: ICategory}> = ({showModal, setShowModal, refresh, setRefresh, data, id}) => {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            await editPoliceStation(id, formData);
...
export default EditPoliceStationModal;